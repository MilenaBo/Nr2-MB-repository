...
public class TaskController {
    ...
    @RequestMapping(method = RequestMethod.GET, value = "getTaskTest")
    public  TaskDto getTaskTest(Long taskId) {return new TaskDto(1L,"test title","test_content");}
    ...
    @RequestMapping(method = RequestMethod.PUT, value = "updateTaskTest")
    public TaskDto updateTaskTest(TaskDto taskDto)
    {return new TaskDto(1L,"Edited test title method PUT","Test CONTENT");}
